...
final class TollPassage {
  private final int TOLL_PLAZA_ID;
  private final String PASSING_VEHICLE_LICENCE_PLATE_NUMBER;
  private final int COST;
  private final LocalTime TIME_OF_PASSING;
  private final LocalDate DATE_OF_PASSING;

  TollPassage(int TOLL_PLAZA_ID, String PASSING_VEHICLE_LICENCE_PLATE_NUMBER, int COST, LocalTime TIME_OF_PASSING, LocalDate DATE_OF_PASSING) {
    ...
    this.PASSING_VEHICLE_LICENCE_PLATE_NUMBER = PASSING_VEHICLE_LICENCE_PLATE_NUMBER;
    this.COST = COST;
  ...
  public String toString() {
    return "TollPassage:" +
        ...
        "\nPASSING_VEHICLE_LICENSE_PLATE_NUMBER: " + PASSING_VEHICLE_LICENCE_PLATE_NUMBER +
        "\nCOST: " + COST +
